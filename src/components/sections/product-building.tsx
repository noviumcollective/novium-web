...
export default function ProductBuilding() {
    ...
    return (
        <div className="px-4 md:px-8 dark:px-0">
            <div className="flex flex-col items-center justify-center md:h-screen container dark:max-w-full dark:px-8 mx-auto bg-transparent dark:bg-novium-gray dark:bg-grid dark:bg-no-repeat dark:bg-cover dark:bg-bottom">
                {/* Header */}
