...
const tabs = [
    {
        ...
        content: (
            <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-novium-green to-novium-dark-green">
    ...
    },
    {
        ...
        content: (
            <div className="w-full overflow-hidden relative h-full rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br from-novium-secondary to-novium-primary font-mono">
                <CardHeader className="px-0 pt-0">
...
export function ServicesTabs() {
    return (
        <div className=" [perspective:1000px] relative flex flex-col container mx-auto w-full items-start justify-start my-40">
            <div className="">
                ...
                <motion.p
                    ...
                    className="py-4 text-lg font-normal text-neutral-600 dark:text-neutral-400"
                >
